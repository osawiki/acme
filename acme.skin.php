...
if ( $this->data['dataAfterContent'] ): ?>
	...
	<div class="scroll-buttons">
		<a class="scroll-button" href="#"><i class="fa fa-chevron-up" aria-hidden="true"></i></a>
		<a class="scroll-bottom" href="#footer"><i class="fa fa-chevron-down" aria-hidden="true"></i></a>
	</div>
	<!--small footer start -->
